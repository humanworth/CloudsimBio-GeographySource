...
import org.cloudbus.cloudsim.VmAllocationPolicyRoundRobin;
 ...
 * cloudlet on it.
 */
public class LoadBalancingRoundRobin2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DatacenterBroker brokerBBO = createBroker();
...
//	double poissonObs =  1;//
	...
	cloudlet0.setUserId(brokerIdBBO);
		...
		for (int i = 0; i < size; i++) {
			...
			if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS) {
				...
				Log.printLine(indent + indent + cloudlet.getResourceId()
						...
						+ indent + indent
						//+dft.format(cloudlet.getUtilizationOfCpu(100))
						);
			}
		}
