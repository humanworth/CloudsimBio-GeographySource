...
import org.cloudbus.cloudsim.TestBroker;
...
public class CloudSimExample4 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TestBroker broker = createBroker();
			...
			//create two VMs
			Vm vm1 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerDynamicWorkload(mips,pesNumber));

			vmid++;
			Vm vm2 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerDynamicWorkload(mips,pesNumber));
	...
	private static TestBroker createBroker(){

		TestBroker broker = null;
		try {
			broker = new TestBroker("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
