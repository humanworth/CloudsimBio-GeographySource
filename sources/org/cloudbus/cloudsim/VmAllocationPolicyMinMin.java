 ...
 */
public class VmAllocationPolicyMinMin extends VmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public VmAllocationPolicyMinMin(List<? extends Host> list) {
		super(list);
	...
	public static List<HostDynamicWorkload> GetAllHosts() {
		List<HostDynamicWorkload> hostList2=new ArrayList<HostDynamicWorkload>();
		...
		for(int i=1;i<5;i++){
			...
			for(HostDynamicWorkload hos:DCHost){
				hostList2.add(hos);
			}
		}
		return hostList2;
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		int idx=0;double determine=Integer.MIN_VALUE;
List<HostDynamicWorkload> hoslist=GetAllHosts();
this.setHostList(hoslist);
for(HostDynamicWorkload hos:hoslist){
	//idx=0;
