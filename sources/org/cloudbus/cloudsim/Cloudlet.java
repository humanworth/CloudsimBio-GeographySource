...
public class Cloudlet {
	...
	private PowerVm OverloadedVm=null;
	...
	public double getEstimatedProcessingCost() {
		...
		cost += accumulatedBwCost;
		// ...plus output cost
		cost += 0.2 * getCloudletTotalLength();
		return cost;
	}
	// Data cloudlet
	...
	public int SetCloudletId(int newId){
		cloudletId=newId;
		return newId;
	}
	
	public PowerVm setOverloadedVm(PowerVm OverVm){
		this.OverloadedVm=OverVm;
	...
	public PowerVm getOverloadedVm(){
		return OverloadedVm; 
	}
}
