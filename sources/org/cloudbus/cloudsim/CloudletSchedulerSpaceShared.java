...
public class CloudletSchedulerSpaceShared extends CloudletScheduler {
			...
			for (int i = 0; i < finished; i++) {
				...
				for (ResCloudlet rcl : getCloudletWaitingList()) {
					if ((currentCpus - usedPes) >= rcl.getNumberOfPes()) {
						rcl.setCloudletStatus2(Cloudlet.INEXEC);
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			if (rcl.getCloudletId() == cloudletId) {
				...
				if (rcl.getRemainingCloudletLength() == 0) {
					...
					rcl.setCloudletStatus2(Cloudlet.CANCELED);
				}
				return rcl.getCloudlet();
			}
		}
	...
	public boolean cloudletPause(int cloudletId) {
		...
		if (found) {
			...
			if (rgl.getRemainingCloudletLength() == 0) {
				...
				rgl.setCloudletStatus2(Cloudlet.PAUSED);
	...
	public void cloudletFinish(ResCloudlet rcl) {
		rcl.setCloudletStatus2(Cloudlet.SUCCESS);
	...
	public double cloudletResume(int cloudletId) {
		...
		if (found) {
			...
			if ((currentCpus - usedPes) >= rcl.getNumberOfPes()) {
				...
				rcl.setCloudletStatus2(Cloudlet.QUEUED);
	...
	@Override
	public boolean addExecuteCloudlet(ResCloudlet rcl) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean deleteExecuteCloudlet(ResCloudlet rcl) {
		// TODO Auto-generated method stub
		return false;
	}
