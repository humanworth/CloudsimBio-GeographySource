 ...
 */
public class PowerVm extends Vm implements Cloneable {

	/** The Constant HISTORY_LENGTH. */
	public static final int HISTORY_LENGTH = 1000;

	/** Back up Vm Redandant */
	
	public int BackupVm=-1;
	...
	public int getBackupVmId(){
		return BackupVm;
	}
	public int setBackupVmId(int newVmId){
		BackupVm=newVmId;
		return newVmId;
	}
	@Override
