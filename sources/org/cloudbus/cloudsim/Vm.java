...
public class Vm {
	...
	public long getFreeRam() {
		return ram-getCurrentRequestedRam();
	}
	public long getFreeBW() {
		return bw-getCurrentRequestedBw();
	}
	public long getFreeSize() {
		return size-currentAllocatedSize;
	}

	public double getFreeMIPS() {
		double result=size;
		for(double x:getCloudletScheduler().getCurrentMipsShare()){
			result-=x;
		}
		return result;
	}
	public boolean setUnsafeMode(boolean unsafeness){
		unsafeMode=unsafeness;
		return unsafeness;
	}
